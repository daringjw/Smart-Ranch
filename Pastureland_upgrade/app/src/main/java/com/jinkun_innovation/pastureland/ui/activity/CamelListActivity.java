...
public class CamelListActivity extends AppCompatActivity {

    private static final String TAG1 = CamelListActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camel_list);
...
//            viewHolder.mTextView.setText(datas[position]);
            ...
            if (variety.equals("701")) {
                viewHolder.tvYangName.setText("品种：骆驼");
            } else {
